  ...
  return (
      ...
      >
        <h1 className="text-lg font-bold">
          Join{" "}
          <span className="bg-[black] text-[white] p-[5px] rounded ">Ai</span>{" "}
          HBridge
        </h1>
        ...
        <div className="flex items-start justify-center flex-col text-sm w-full gap-2 mt-2 mb-2">
        ...
        <div className="flex items-start justify-center flex-col w-full gap-2 mt-2 mb-2">
        ...
        <Button
          className="w-full mt-[30px] bg-secondary"
          size="lg"
